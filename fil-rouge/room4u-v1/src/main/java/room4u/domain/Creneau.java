...
public final class Creneau {
    ...
    // LocalDate (12/03/2024)
    // LocalTime (14:30)
    // LocalDateTime (12/03/2024 14:30)
    // ZonedDateTime // (12/03/2024 14:30 + fuseau horaire)
    // Duration // durée entre deux instants (respecte les unités de temps)
    // Period // durée en années, mois, jours
    // Instant // un point précis dans le temps (UTC) => secondes depuis 1970
    ...
    /**
     * Indique si le créneau est complètement dans le passé.
     */
    ...
    /**
     * Renvoie la durée du créneau en minutes.
     */
    public long dureeEnMinutes() {
